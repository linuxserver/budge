...
//       await manager.update(Budget, budget.id, budget)
//     }
...
//     await manager.update(BudgetMonth, budgetMonth.id, budgetMonth)
...
//     await manager.update(CategoryMonth, nextCategoryMonth.id, nextCategoryMonth)
//   }
// }
