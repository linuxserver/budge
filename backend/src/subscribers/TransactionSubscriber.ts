...
//       await manager.getRepository(CategoryMonth).update(currentCCMonth.id, currentCCMonth)
//     }
//   }
...
//         date: transaction.date,
//       })
//       await manager.getRepository(Transaction).update(transferTransaction.id, transferTransaction)
//       return
//     }
...
//           status: TransactionStatus.Pending,
//         })
//         await manager.update(Transaction, transferTransaction.id, transferTransaction)
//         transaction.transferTransactionId = transferTransaction.id
//       }
//     }
//   }
...
//       await manager.getRepository(CategoryMonth).update(categoryMonth.id, categoryMonth)
