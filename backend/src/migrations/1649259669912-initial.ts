...
export class initial1649259669912 implements MigrationInterface {
  name = 'initial1649259669912'

  public async up(queryRunner: QueryRunner): Promise<void> {
    try {
      const tables = await queryRunner.query('SELECT COUNT(*) FROM users')
      //   console.log('Initial database has already been created, skipping this migration')
    } catch (err) {
